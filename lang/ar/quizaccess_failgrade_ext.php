...
/**
 * Arabic language strings for the quizaccess_failgrade_ext plugin.
 *
...
$string['competencytable_heading'] = 'جدول تقدم الجدارات الخاصة بالاختبار';
$string['competencytable_comp'] = 'الجدارة الفنية';
$string['competencytable_required'] = 'حد النجاح المطلوب';
$string['competencytable_achieved'] = 'نسبتك الحالية';
