...
/**
 * quizaccess_failgrade_ext plugin upgrade steps.
 *
...
function xmldb_quizaccess_failgrade_ext_upgrade($oldversion) {
    ...
    if ($oldversion < 2026051901) {
        // Define field competencythreshold to be added to quizaccess_failgrade_ext.
        $table = new xmldb_table('quizaccess_failgrade_ext');
