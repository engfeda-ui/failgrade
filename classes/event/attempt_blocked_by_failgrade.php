...
class attempt_blocked_by_failgrade extends base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' was blocked from attempting the quiz with course module id '$this->contextinstanceid' because they have already satisfied the passing criteria (mode: {$this->other['mode']}).";
    }
